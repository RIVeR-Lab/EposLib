// GatewayEposToCANopen.cpp: Implementierung der Klasse CGatewayEposToCANopen.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "GatewayEposToCANopen.h"
...
//////////////////////////////////////////////////////////////////////
CGatewayEposToCANopen::CGatewayEposToCANopen()
{
...
CGateway* CGatewayEposToCANopen::Clone()
{
    CGatewayEposToCANopen* pClonedGateway;

    pClonedGateway = new CGatewayEposToCANopen();
    *pClonedGateway = *this;

    return pClonedGateway;
}

CGatewayEposToCANopen& CGatewayEposToCANopen::operator=(CGatewayEposToCANopen& other)
{
    if(this != &other)
    {
...
BOOL CGatewayEposToCANopen::ProcessCommand(CCommandRoot* pCommand, CLayerManagerBase* pManager, HANDLE h_Handle, HANDLE hTransactionHandle)
{
    ...
    if(CGateway::ProcessCommand(pCommand, pManager, h_Handle, hTransactionHandle))
	{
		if(CheckLayers(pCommand, pManager))
		{
			...
			switch(pCommand->GetCommandId())
			{
				...
				case EPOS_SEND_LSS_FRAME: return Process_SendLSSFrame(pCommand_DCS, pProtocolStackManager, h_Handle, hTransactionHandle);
				case EPOS_READ_LSS_FRAME: return Process_ReadLSSFrame(pCommand_DCS, pProtocolStackManager, h_Handle, hTransactionHandle);
...
BOOL CGatewayEposToCANopen::Process_ReadObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEposToCANopen::Process_WriteObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_INDEX = 0;
    const int PARAMETER_INDEX_SUB_INDEX = 1;
...
BOOL CGatewayEposToCANopen::Process_InitiateSegmentedRead(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_INDEX = 0;
    const int PARAMETER_INDEX_SUB_INDEX = 1;
...
BOOL CGatewayEposToCANopen::Process_AbortSegmentedTransfer(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEposToCANopen::Process_InitiateSegmentedWrite(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_INDEX = 0;
    const int PARAMETER_INDEX_SUB_INDEX = 1;
...
BOOL CGatewayEposToCANopen::Process_SegmentRead(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
...
BOOL CGatewayEposToCANopen::Process_SegmentWrite(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
    const int PARAMETER_INDEX_CONTROL_BYTE = 1;
...
BOOL CGatewayEposToCANopen::Process_SendNMTService(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
...
BOOL CGatewayEposToCANopen::Process_SendCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEposToCANopen::Process_ReadCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
//*Constants DCS*
    const int PARAMETER_INDEX_COB_ID = 0;
    const int PARAMETER_INDEX_LENGTH = 1;
...
BOOL CGatewayEposToCANopen::Process_RequestCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_COB_ID = 0;
    const int PARAMETER_INDEX_LENGTH = 1;
...
BOOL CGatewayEposToCANopen::Process_SendLSSFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEposToCANopen::Process_ReadLSSFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEposToCANopen::Process_ReadODObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
    const int PARAMETER_INDEX_INDEX = 1;
    ...
    if(pCommand)
    {
        ...
        //Check Max DataLength
        if(wNbOfBytesToRead > MAX_DATA_LENGTH) wNbOfBytesToRead = MAX_DATA_LENGTH;

        //Prepare DataBuffer
        memset(maxDataBuffer, 0, MAX_DATA_LENGTH);
        uSubIndex = (BYTE)wSubIndex;

        //Prepare PS Parameter
        CalculateDefaultSdoCobIds((BYTE)wNodeId, &dCobIdClientServer, &dCobIdServerClient);

        //Execute Command
        oResult = PS_InitiateSDOUpload(pProtocolStackManager, hPS_Handle, hTransactionHandle, dCobIdClientServer, dCobIdServerClient, wIndex, uSubIndex, &oExpeditedTransfer, &oSizeIndicated, &uNonValidNbOfBytes, maxDataBuffer, MAX_DATA_LENGTH, &dAbortCode, &comErrorInfo);
        oResult = EvaluateErrorCode(oResult, dAbortCode, &comErrorInfo, &cmdErrorInfo);

        //Restore PS ReturnParameter
        if(dAbortCode == 0) dDeviceErrorCodeTemp = k_NoError; else dDeviceErrorCodeTemp = k_Error_OldDeviceEpos_SdoAbort;
        wDeviceErrorCode = (WORD)dDeviceErrorCodeTemp;
        if(oExpeditedTransfer) wSegmentedRead = 0; else wSegmentedRead = 1;
        wNbOfBytesRead = MAX_DATA_LENGTH - uNonValidNbOfBytes;

        //Set DCS ReturnParameter Data
        pCommand->SetStatus(oResult, &cmdErrorInfo);
        pCommand->SetReturnParameterData(RETURN_PARAMETER_INDEX_ERROR_CODE, &wDeviceErrorCode, sizeof(wDeviceErrorCode));
        pCommand->SetReturnParameterData(RETURN_PARAMETER_INDEX_SEGMENTED_READ, &wSegmentedRead, sizeof(wSegmentedRead));
        pCommand->SetReturnParameterData(RETURN_PARAMETER_INDEX_BYTES_READ, &wNbOfBytesRead, sizeof(wNbOfBytesRead));
        pCommand->SetReturnParameterData(RETURN_PARAMETER_INDEX_DATA, maxDataBuffer, wNbOfBytesRead);
...
BOOL CGatewayEposToCANopen::Process_ReadODObjectNextSegment(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
    const int PARAMETER_INDEX_INDEX = 1;
    ...
    if(pCommand)
    {
        ...
        //Check Max NbOfBytesToRead
        if(wNbOfBytesToRead > MAX_SEGMENT_LENGTH) wNbOfBytesToRead = MAX_SEGMENT_LENGTH;
        ...
        if(dAbortCode == 0) dDeviceErrorCodeTemp = k_NoError; else dDeviceErrorCodeTemp = k_Error_OldDeviceEpos_SdoAbort;
        wDeviceErrorCode = (WORD)dDeviceErrorCodeTemp;
        if(oNoMoreSegments) wSegmentedRead = 0; else wSegmentedRead = 1;
        wNbOfBytesRead = MAX_SEGMENT_LENGTH-uNonValidNbOfBytes;
...
BOOL CGatewayEposToCANopen::Process_WriteODObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
    const int PARAMETER_INDEX_INDEX = 1;
    ...
    if(pCommand)
    {
        ...
        //Prepare PS Parameter
        CalculateDefaultSdoCobIds((BYTE)wNodeId, &dCobIdClientServer, &dCobIdServerClient);
        if(wNbOfBytesToWrite <= MAX_DATA_LENGTH)
        {
            //Expedited Transfer
            oExpeditedTransfer = TRUE;
            oSizeIndicated = TRUE;
            uNonValidNbOfBytes = (BYTE)(MAX_DATA_LENGTH - wNbOfBytesToWrite);
            uSubIndex = (BYTE)wSubIndex;
            pCommand->GetParameterData(PARAMETER_INDEX_DATA, maxDataBuffer, wNbOfBytesToWrite);
        }
        else
        {
            ...
            uNonValidNbOfBytes = 0;
            uSubIndex = (BYTE)wSubIndex;
            pCommand->GetParameterData(PARAMETER_INDEX_NB_OF_BYTES_TO_WRITE, maxDataBuffer, sizeof(wNbOfBytesToWrite));
        }

        //Execute Command
        oResult = PS_InitiateSDODownload(pProtocolStackManager, hPS_Handle, hTransactionHandle, dCobIdClientServer, dCobIdServerClient, oExpeditedTransfer, oSizeIndicated, uNonValidNbOfBytes, wIndex, uSubIndex, maxDataBuffer, MAX_DATA_LENGTH, &dAbortCode, &comErrorInfo);
        oResult = EvaluateErrorCode(oResult, dAbortCode, &comErrorInfo, &cmdErrorInfo);
        ...
        if(dAbortCode == 0) dDeviceErrorCodeTemp = k_NoError; else dDeviceErrorCodeTemp = k_Error_OldDeviceEpos_SdoAbort;
        wDeviceErrorCode = (WORD)dDeviceErrorCodeTemp;
        if(oExpeditedTransfer) wSegmentedWrite = 1; else wSegmentedWrite = 0;
        wNbOfBytesWritten = MAX_DATA_LENGTH-uNonValidNbOfBytes;
...
BOOL CGatewayEposToCANopen::Process_WriteODObjectNextSegment(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_NODE_ID = 0;
    ...
    if(pCommand)
    {
        ...
        //Prepare PS Parameter
        CalculateDefaultSdoCobIds((BYTE)wNodeId, &dCobIdClientServer, &dCobIdServerClient);
        uNonValidNbOfBytes = (BYTE)(MAX_SEGMENT_LENGTH - wNbOfBytesToWrite);
        if(wNbOfBytesToWrite < MAX_SEGMENT_LENGTH)
        {
            //End of Segmented Transfer
            oNoMoreSegments = TRUE;
        }
        else
        {
            //More Segments to Transfer
        ...
        if(dAbortCode == 0) dDeviceErrorCodeTemp = k_NoError; else dDeviceErrorCodeTemp = k_Error_OldDeviceEpos_SdoAbort;
        wDeviceErrorCode = (WORD)dDeviceErrorCodeTemp;
        if(oNoMoreSegments) wSegmentedWrite = 0; else wSegmentedWrite = 1;
        wNbOfBytesWritten = MAX_SEGMENT_LENGTH-uNonValidNbOfBytes;
...
BOOL CGatewayEposToCANopen::EvaluateErrorCode(BOOL oResult, DWORD dDeviceErrorCode, CErrorInfo* pComErrorInfo, CErrorInfo* pCmdErrorInfo)
{
...
void CGatewayEposToCANopen::InitCommands()
{
    DeleteCommands();
...
void CGatewayEposToCANopen::DeleteCommands()
{
...
BOOL CGatewayEposToCANopen::PS_AbortSDOTransfer(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, DWORD dCobIdClientServer, WORD wIndex, BYTE uSubIndex, DWORD dAbortCode, CErrorInfo* pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CGatewayEposToCANopen::PS_SendNMTService(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, BYTE uCommandSpecifier, BYTE uNodeId, CErrorInfo* pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CGatewayEposToCANopen::PS_SendCANFrame(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, DWORD dCobId, BYTE uLength, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
...
BOOL CGatewayEposToCANopen::PS_ReadCANFrame(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, DWORD dCobId, BYTE uLength, void* pDataBuffer, DWORD dDataBufferLength, DWORD p_ulTimeout, CErrorInfo* pErrorInfo)
{
    const DWORD MAX_CAN_DATA = 8;
...
BOOL CGatewayEposToCANopen::PS_RequestCANFrame(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, DWORD dCobId, BYTE uLength, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
    const DWORD MAX_CAN_DATA = 8;
...
BOOL CGatewayEposToCANopen::PS_SendLSSFrame(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
    const DWORD MAX_CAN_DATA = 8;
...
BOOL CGatewayEposToCANopen::PS_ReadLSSFrame(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, WORD wTimeout, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
    const DWORD MAX_CAN_DATA = 8;
...
BOOL CGatewayEposToCANopen::CalculateDefaultSdoCobIds(BYTE uNodeId, DWORD* pdCobIdClientServer, DWORD* pdCobIdServerClient)
{
...
BOOL CGatewayEposToCANopen::InitErrorHandling()
{
    CErrorProducer errorProducer;
    CStdString strClassName = "GatewayEposToCANopen";
...
BOOL CGatewayEposToCANopen::InitLayerParameterStack(CCommandRoot* p_pCommand)
{
