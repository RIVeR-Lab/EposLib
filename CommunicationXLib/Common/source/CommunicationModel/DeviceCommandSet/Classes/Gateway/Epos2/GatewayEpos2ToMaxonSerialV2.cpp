// GatewayEpos2ToMaxonSerialV2.cpp: Implementierung der Klasse CGatewayEpos2ToMaxonSerialV2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "GatewayEpos2ToMaxonSerialV2.h"
#include <malloc.h>
#include <memory.h>
...
//////////////////////////////////////////////////////////////////////
CGatewayEpos2ToMaxonSerialV2::CGatewayEpos2ToMaxonSerialV2()
{
...
CGateway* CGatewayEpos2ToMaxonSerialV2::Clone()
{
    CGatewayEpos2ToMaxonSerialV2* pClonedGateway;

    pClonedGateway = new CGatewayEpos2ToMaxonSerialV2();
    *pClonedGateway = *this;

    return pClonedGateway;
}

CGatewayEpos2ToMaxonSerialV2& CGatewayEpos2ToMaxonSerialV2::operator=(CGatewayEpos2ToMaxonSerialV2& other)
{
    if(this != &other)
    {
...
BOOL CGatewayEpos2ToMaxonSerialV2::ProcessCommand(CCommandRoot* pCommand, CLayerManagerBase* pManager, HANDLE h_Handle, HANDLE hTransactionHandle)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_ReadObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_WriteObject(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    const BYTE MAX_OBJECT_LENGTH = 4;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_InitiateSegmentedRead(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_INDEX = 0;
    const int PARAMETER_INDEX_SUB_INDEX = 1;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_InitiateSegmentedWrite(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
    const int PARAMETER_INDEX_INDEX = 0;
    const int PARAMETER_INDEX_SUB_INDEX = 1;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_SegmentRead(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    //*Constants DCS*
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_SegmentWrite(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_AbortSegmentedTransfer(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    BOOL oResult = FALSE;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_SendNMTService(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_SendCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_ReadCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    const BYTE MAX_FRAME_LENGTH = 8;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_RequestCANFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    const BYTE MAX_FRAME_LENGTH = 8;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_SendLSSFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    const BYTE MAX_FRAME_LENGTH = 8;
...
BOOL CGatewayEpos2ToMaxonSerialV2::Process_ReadLSSFrame(CCommand_DCS* pCommand, CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle)
{
    const BYTE MAX_FRAME_LENGTH = 8;
...
BOOL CGatewayEpos2ToMaxonSerialV2::EvaluateErrorCode(BOOL oResult, DWORD dDeviceErrorCode, CErrorInfo* pComErrorInfo, CErrorInfo* pCmdErrorInfo)
{
...
//*************************************************************************************
BOOL CGatewayEpos2ToMaxonSerialV2::PS_ProcessProtocol(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, BYTE uOpCode, void* pDataBuffer, DWORD dDataBufferLength, BYTE ubKeepLock, void** ppRetDataBuffer, DWORD* pdRetDataBufferLength, CErrorInfo* pErrorInfo)
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::PS_AbortProtocol(CProtocolStackManagerBase* pProtocolStackManager, HANDLE hPS_Handle, HANDLE hTransactionHandle, CErrorInfo* pErrorInfo)
{
	BOOL oResult = FALSE;
...
void CGatewayEpos2ToMaxonSerialV2::InitCommands()
{
    DeleteCommands();
...
void CGatewayEpos2ToMaxonSerialV2::DeleteCommands()
{
...
BOOL CGatewayEpos2ToMaxonSerialV2::CopyData(void*& pDest, void* pSource, DWORD sourceSize)
{
    BYTE* p;
...
BOOL CGatewayEpos2ToMaxonSerialV2::CopyReturnData(void* pDest, DWORD destSize, void*& pSource, DWORD& sourceSize)
{
    BYTE* p;
...
/************************************************************************/
BOOL CGatewayEpos2ToMaxonSerialV2::InitErrorHandling()
{
    CErrorProducer errorProducer;
    CStdString strClassName = "GatewayEpos2ToMaxonSerialV2";
...
BOOL CGatewayEpos2ToMaxonSerialV2::InitLayerParameterStack(CCommandRoot* p_pCommand)
{
