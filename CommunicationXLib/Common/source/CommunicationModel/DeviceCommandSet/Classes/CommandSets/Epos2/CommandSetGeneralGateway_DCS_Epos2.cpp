// CommandSetGeneralGateway_DCS_Epos2.cpp: Implementierung der Klasse CCommandSetGeneralGateway_DCS_Epos2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetGeneralGateway_DCS_Epos2.h"
...
BOOL CCommandSetGeneralGateway_DCS_Epos2::DCS_SendCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, WORD wCobID, WORD wLength, void* pData, CErrorInfo* pErrorInfo)
{
...
BOOL CCommandSetGeneralGateway_DCS_Epos2::DCS_ReadCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, WORD wCobID, WORD wLength, void* pData, DWORD p_ulTimeOut, CErrorInfo* pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetGeneralGateway_DCS_Epos2::DCS_RequestCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, WORD wCobID, WORD wLength, void* pData, CErrorInfo* pErrorInfo)
{
    DWORD dDeviceErrorCode = 0;
    BOOL oResult = FALSE;
...
void CCommandSetGeneralGateway_DCS_Epos2::DeleteCommands()
{
    if(m_pCommand_RequestCANFrame)
    {
...
void CCommandSetGeneralGateway_DCS_Epos2::InitJournalManager(CJournalManagerBase* pJournalManager)
{
...
void CCommandSetGeneralGateway_DCS_Epos2::ResetJournalManager()
{
...
BOOL CCommandSetGeneralGateway_DCS_Epos2::InitGateway(CGateway *pGateway)
{
...
CXXMLFile::CElementPart* CCommandSetGeneralGateway_DCS_Epos2::StoreToXMLFile(CXXMLFile* pFile, CXXMLFile::CElementPart* pParentElement)
{
