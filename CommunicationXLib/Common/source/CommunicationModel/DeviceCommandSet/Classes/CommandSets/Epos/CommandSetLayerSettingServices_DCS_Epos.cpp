// CommandSetLayerSettingServices_DCS_Epos.cpp: Implementierung der Klasse CCommandSetLayerSettingServices_DCS_Epos.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetLayerSettingServices_DCS_Epos.h"
...
CCommandSetLayerSettingServices_DCS_Epos::CCommandSetLayerSettingServices_DCS_Epos()
{
...
BOOL CCommandSetLayerSettingServices_DCS_Epos::DCS_SendLSSFrame(CLayerManagerBase* pManager,HANDLE hHandle,HANDLE hTransactionHandle,void* pDataBuffer,DWORD dDataBufferLength,CErrorInfo* pErrorInfo)
{
...
BOOL CCommandSetLayerSettingServices_DCS_Epos::DCS_ReadLSSFrame(CLayerManagerBase* pManager,HANDLE hHandle,HANDLE hTransactionHandle,WORD wTimeout,void* pDataBuffer,DWORD dDataBufferLength,CErrorInfo* pErrorInfo)
{
	DWORD dDeviceErrorCode = 0;
	BOOL oResult = FALSE;
...
void CCommandSetLayerSettingServices_DCS_Epos::InitCommands()
{
	DeleteCommands();
...
void CCommandSetLayerSettingServices_DCS_Epos::DeleteCommands()
{
	if(m_pCommand_SendLSSFrame)
	{
...
void CCommandSetLayerSettingServices_DCS_Epos::InitJournalManager(CJournalManagerBase* pJournalManager)
{
...
void CCommandSetLayerSettingServices_DCS_Epos::ResetJournalManager()
{
...
BOOL CCommandSetLayerSettingServices_DCS_Epos::InitGateway(CGateway *pGateway)
{
...
CXXMLFile::CElementPart* CCommandSetLayerSettingServices_DCS_Epos::StoreToXMLFile(CXXMLFile* pFile,CXXMLFile::CElementPart* pParentElement)
{
