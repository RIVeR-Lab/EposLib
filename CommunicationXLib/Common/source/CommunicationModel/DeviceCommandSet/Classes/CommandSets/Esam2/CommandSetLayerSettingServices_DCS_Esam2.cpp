// CommandSetLayerSettingServices_DCS_Esam2.cpp: Implementierung der Klasse CCommandSetLayerSettingServices_DCS_Esam2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetLayerSettingServices_DCS_Esam2.h"
...
CCommandSetLayerSettingServices_DCS_Esam2::CCommandSetLayerSettingServices_DCS_Esam2()
{
...
BOOL CCommandSetLayerSettingServices_DCS_Esam2::DCS_SendLSSFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, WORD wNetworkId, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
...
BOOL CCommandSetLayerSettingServices_DCS_Esam2::DCS_ReadLSSFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, WORD wNetworkId, WORD wTimeout, void* pDataBuffer, DWORD dDataBufferLength, CErrorInfo* pErrorInfo)
{
    DWORD dDeviceErrorCode = 0;
    BOOL oResult = FALSE;
...
void CCommandSetLayerSettingServices_DCS_Esam2::InitCommands()
{
    DeleteCommands();
    ...
    m_pCommand_ReadLSSFrame->InitCommand(ESAM2_SEND_LSS_FRAME);
}

void CCommandSetLayerSettingServices_DCS_Esam2::DeleteCommands()
{
    if(m_pCommand_SendLSSFrame)
    {
...
void CCommandSetLayerSettingServices_DCS_Esam2::InitJournalManager(CJournalManagerBase* pJournalManager)
{
...
void CCommandSetLayerSettingServices_DCS_Esam2::ResetJournalManager()
{
...
BOOL CCommandSetLayerSettingServices_DCS_Esam2::InitGateway(CGateway *pGateway)
{
...
CXXMLFile::CElementPart* CCommandSetLayerSettingServices_DCS_Esam2::StoreToXMLFile(CXXMLFile* pFile, CXXMLFile::CElementPart* pParentElement)
{
