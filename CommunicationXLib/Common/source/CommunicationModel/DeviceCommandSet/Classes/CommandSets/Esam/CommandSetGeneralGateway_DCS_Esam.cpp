// CommandSetGeneralGateway_DCS_Esam.cpp: Implementierung der Klasse CCommandSetGeneralGateway_DCS_Esam.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetGeneralGateway_DCS_Esam.h"
...
CCommandSetGeneralGateway_DCS_Esam::CCommandSetGeneralGateway_DCS_Esam()
{
...
BOOL CCommandSetGeneralGateway_DCS_Esam::DCS_SendCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, BYTE uPortNumber, WORD wCobID, WORD wLength, void* pData, CErrorInfo* pErrorInfo)
{
...
BOOL CCommandSetGeneralGateway_DCS_Esam::DCS_ReadCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, BYTE uPortNumber, WORD wCobID, WORD wLength, void* pData, DWORD p_ulTimeOut, CErrorInfo* pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetGeneralGateway_DCS_Esam::DCS_RequestCANFrame(CLayerManagerBase* pManager, HANDLE hHandle, HANDLE hTransactionHandle, BYTE uPortNumber, WORD wCobID, WORD wLength, void* pData, CErrorInfo* pErrorInfo)
{
    DWORD dDeviceErrorCode = 0;
    BOOL oResult = FALSE;
...
void CCommandSetGeneralGateway_DCS_Esam::InitCommands()
{
    DeleteCommands();
...
void CCommandSetGeneralGateway_DCS_Esam::DeleteCommands()
{
    if(m_pCommand_RequestCANFrame)
    {
...
void CCommandSetGeneralGateway_DCS_Esam::InitJournalManager(CJournalManagerBase* pJournalManager)
{
...
void CCommandSetGeneralGateway_DCS_Esam::ResetJournalManager()
{
...
BOOL CCommandSetGeneralGateway_DCS_Esam::InitGateway(CGateway *pGateway)
{
...
CXXMLFile::CElementPart* CCommandSetGeneralGateway_DCS_Esam::StoreToXMLFile(CXXMLFile* pFile, CXXMLFile::CElementPart* pParentElement)
{
