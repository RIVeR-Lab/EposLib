// CommandGroupStandard_DCS_Esam2.cpp: Implementierung der Klasse CCommandGroupStandard_DCS_Esam2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandGroupStandard_DCS_Esam2.h"
#include "../../CommandSets/Esam2/CommandSetObjectDictionary_DCS_Esam2.h"
#include "../../CommandSets/Esam2/CommandSetNetworkManagement_DCS_Esam2.h"
#include "../../CommandSets/Esam2/CommandSetGeneralGateway_DCS_Esam2.h"
#include "../../CommandSets/Esam2/CommandSetLayerSettingServices_DCS_Esam2.h"
...
//////////////////////////////////////////////////////////////////////
CCommandGroupStandard_DCS_Esam2::CCommandGroupStandard_DCS_Esam2()
{
...
void CCommandGroupStandard_DCS_Esam2::FillSetList()
{
	m_pCommandSetObjectDictionary = new CCommandSetObjectDictionary_DCS_Esam2();
	m_pCommandSetNetworkManagement = new CCommandSetNetworkManagement_DCS_Esam2();
    m_pCommandSetGeneralGateway = new CCommandSetGeneralGateway_DCS_Esam2();
    m_pCommandSetLayerSettingServices = new CCommandSetLayerSettingServices_DCS_Esam2();
}

void CCommandGroupStandard_DCS_Esam2::DeleteSetList()
{
...
void CCommandGroupStandard_DCS_Esam2::InitJournalManager(CJournalManagerBase* pJournalManager)
{
...
void CCommandGroupStandard_DCS_Esam2::ResetJournalManager()
{
...
BOOL CCommandGroupStandard_DCS_Esam2::InitGateway(CGateway *pGateway)
{
...
CXXMLFile::CElementPart* CCommandGroupStandard_DCS_Esam2::StoreToXMLFile(CXXMLFile* pFile, CXXMLFile::CElementPart* pParentElement)
{
