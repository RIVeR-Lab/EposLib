// CommandSetMotionInfo_VCS_Drive2.cpp: Implementierung der Klasse CCommandSetMotionInfo_VCS_Drive2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetMotionInfo_VCS_Drive2.h"
...
//////////////////////////////////////////////////////////////////////
CCommandSetMotionInfo_VCS_Drive2::CCommandSetMotionInfo_VCS_Drive2()
{
...
BOOL CCommandSetMotionInfo_VCS_Drive2::VCS_GetCurrentIs(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, short* p_psCurrentIs, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetMotionInfo_VCS_Drive2::VCS_GetMovementState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, BOOL* p_poTargetReached, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetMotionInfo_VCS_Drive2::InitCommands()
{
    DeleteCommands();

    //Init GetCurrentIs
    m_pCommand_GetCurrentIs = new CCommand_VCS_Drive2();
    m_pCommand_GetCurrentIs->InitCommand(DRIVE2_GET_CURRENT_IS);

    //Init GetMovementState
    m_pCommand_GetMovementState = new CCommand_VCS_Drive2();
    m_pCommand_GetMovementState->InitCommand(DRIVE2_GET_MOVEMENT_STATE);

    //Init GetPositionIs
    m_pCommand_GetPositionIs = new CCommand_VCS_Drive2();
    m_pCommand_GetPositionIs->InitCommand(DRIVE2_GET_POSITION_IS);

    //Init GetVelocityIs
    m_pCommand_GetVelocityIs = new CCommand_VCS_Drive2();
    m_pCommand_GetVelocityIs->InitCommand(DRIVE2_GET_VELOCITY_IS);
}

void CCommandSetMotionInfo_VCS_Drive2::DeleteCommands()
{
    if(m_pCommand_GetCurrentIs)
    {
...
CXXMLFile::CElementPart* CCommandSetMotionInfo_VCS_Drive2::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetMotionInfo_VCS_Drive2::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetMotionInfo_VCS_Drive2::ResetJournalManager()
{
...
BOOL CCommandSetMotionInfo_VCS_Drive2::InitGateway(CGateway *p_pGateway)
{
