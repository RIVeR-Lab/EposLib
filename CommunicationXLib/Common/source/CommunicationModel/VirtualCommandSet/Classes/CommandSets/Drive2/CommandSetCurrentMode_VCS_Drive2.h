// CommandSetCurrentMode_VCS_Drive2.h: Schnittstelle f�r die Klasse CCommandSetCurrentMode_VCS_Drive2.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CommandSetCurrentMode_VCS_Drive2_H__3D064F9C_00E0_4989_921F_7580447D6C35__INCLUDED_)
#define AFX_CommandSetCurrentMode_VCS_Drive2_H__3D064F9C_00E0_4989_921F_7580447D6C35__INCLUDED_
...
class CCommandSetCurrentMode_VCS_Drive2 : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetCurrentMode_VCS_Drive2();
    virtual ~CCommandSetCurrentMode_VCS_Drive2();
...
private:
    ...
    CCommand_VCS_Drive2* m_pCommand_GetCurrentMust;
    CCommand_VCS_Drive2* m_pCommand_SetCurrentMust;
    CCommand_VCS_Drive2* m_pCommand_ActivateAnalogCurrentSetpoint;
    CCommand_VCS_Drive2* m_pCommand_DeactivateAnalogCurrentSetpoint;
    CCommand_VCS_Drive2* m_pCommand_EnableAnalogCurrentSetpoint;
    CCommand_VCS_Drive2* m_pCommand_DisableAnalogCurrentSetpoint;
};

#endif // !defined(AFX_CommandSetCurrentMode_VCS_Drive2_H__3D064F9C_00E0_4989_921F_7580447D6C35__INCLUDED_)
