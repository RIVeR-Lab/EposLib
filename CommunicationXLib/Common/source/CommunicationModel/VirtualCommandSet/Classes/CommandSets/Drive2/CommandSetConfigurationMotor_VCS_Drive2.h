...
class CCommandSetConfigurationMotor_VCS_Drive2 : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetConfigurationMotor_VCS_Drive2(void);
    virtual ~CCommandSetConfigurationMotor_VCS_Drive2(void);
...
private:
    ...
    CCommand_VCS_Drive2* m_pCommand_SetMotorParameter;
    CCommand_VCS_Drive2* m_pCommand_GetMotorParameter;
    CCommand_VCS_Drive2* m_pCommand_SetMotorType;
    CCommand_VCS_Drive2* m_pCommand_GetMotorType;
    CCommand_VCS_Drive2* m_pCommand_SetDcMotorParameter;
    CCommand_VCS_Drive2* m_pCommand_GetDcMotorParameter;
    CCommand_VCS_Drive2* m_pCommand_SetEcMotorParameter;
    CCommand_VCS_Drive2* m_pCommand_GetEcMotorParameter;
};
