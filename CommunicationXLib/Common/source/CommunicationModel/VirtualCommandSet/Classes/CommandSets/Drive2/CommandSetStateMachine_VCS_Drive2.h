// CommandSetStateMachine_VCS_Drive2.h: Schnittstelle f�r die Klasse CCommandSetStateMachine_VCS_Drive2.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CommandSetStateMachine_VCS_Drive2_H__C9618274_651E_43F9_944B_C9B1BE9690CB__INCLUDED_)
#define AFX_CommandSetStateMachine_VCS_Drive2_H__C9618274_651E_43F9_944B_C9B1BE9690CB__INCLUDED_
...
class CCommandSetStateMachine_VCS_Drive2 : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetStateMachine_VCS_Drive2();
    virtual ~CCommandSetStateMachine_VCS_Drive2();
...
private:
    ...
    CCommand_VCS_Drive2* m_pCommand_ClearFault;
    CCommand_VCS_Drive2* m_pCommand_GetDisableState;
    CCommand_VCS_Drive2* m_pCommand_GetEnableState;
    CCommand_VCS_Drive2* m_pCommand_GetFaultState;
    CCommand_VCS_Drive2* m_pCommand_GetOperationMode;
    CCommand_VCS_Drive2* m_pCommand_GetQuickStopState;
    CCommand_VCS_Drive2* m_pCommand_SetDisableState;
    CCommand_VCS_Drive2* m_pCommand_SetEnableState;
    CCommand_VCS_Drive2* m_pCommand_SetOperationMode;
    CCommand_VCS_Drive2* m_pCommand_SetQuickStopState;
};

#endif // !defined(AFX_CommandSetStateMachine_VCS_Drive2_H__C9618274_651E_43F9_944B_C9B1BE9690CB__INCLUDED_)
