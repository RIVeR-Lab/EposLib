// CommandSetInputsPositionMarker_VCS_Drive2.cpp: Implementierung der Klasse CCommandSetInputsPositionMarker_VCS_Drive2.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_SetPositionMarkerParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, BYTE p_ubPositionMarkerEdgeType, BYTE p_ubPositionMarkerMode, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_GetPositionMarkerParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, BYTE* p_pubPositionMarkerEdgeType, BYTE* p_pubPositionMarkerMode, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_ActivatePositionMarker(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usDigitalInputNumber, BOOL p_oPolarity, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_DeactivatePositionMarker(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usDigitalInputNumber, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_ReadPositionMarkerCounter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD* p_pCount, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_ReadPositionMarkerCapturedPosition(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usCountIndex, long* p_plCapturedPosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::VCS_ResetPositionMarkerCounter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetInputsPositionMarker_VCS_Drive2::DeleteCommands()
{
    if(m_pCommand_SetPositionMarkerParameter)
    {
...
CXXMLFile::CElementPart* CCommandSetInputsPositionMarker_VCS_Drive2::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetInputsPositionMarker_VCS_Drive2::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetInputsPositionMarker_VCS_Drive2::ResetJournalManager()
{
...
BOOL CCommandSetInputsPositionMarker_VCS_Drive2::InitGateway(CGateway *p_pGateway)
{
