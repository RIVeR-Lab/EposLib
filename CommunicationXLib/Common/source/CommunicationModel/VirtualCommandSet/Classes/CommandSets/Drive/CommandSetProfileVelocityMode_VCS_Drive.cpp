// CommandSetProfileVelocityMode_VCS_Drive.cpp: Implementierung der Klasse CCommandSetProfileVelocityMode_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetProfileVelocityMode_VCS_Drive.h"
...
//////////////////////////////////////////////////////////////////////
CCommandSetProfileVelocityMode_VCS_Drive::CCommandSetProfileVelocityMode_VCS_Drive()
{
...
BOOL CCommandSetProfileVelocityMode_VCS_Drive::VCS_GetVelocityProfile(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD* p_pdProfileAcceleration, DWORD* p_pdProfileDeceleration, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfileVelocityMode_VCS_Drive::VCS_HaltVelocityMovement(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfileVelocityMode_VCS_Drive::VCS_SetVelocityProfile(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD p_ulProfileAcceleration, DWORD p_ulProfileDeceleration, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetProfileVelocityMode_VCS_Drive::InitCommands()
{
    DeleteCommands();

    //Init GetTargetVelocity
    m_pCommand_GetTargetVelocity = new CCommand_VCS_Drive();
    m_pCommand_GetTargetVelocity->InitCommand(DRIVE_GET_TARGET_VELOCITY);

    //Init GetVelocityProfile
    m_pCommand_GetVelocityProfile = new CCommand_VCS_Drive();
    m_pCommand_GetVelocityProfile->InitCommand(DRIVE_GET_VELOCITY_PROFILE);

    //Init HaltVelocityMovement
    m_pCommand_HaltVelocityMovement = new CCommand_VCS_Drive();
    m_pCommand_HaltVelocityMovement->InitCommand(DRIVE_HALT_VELOCITY_MOVEMENT);

    //Init MoveWithVelocity
    m_pCommand_MoveWithVelocity = new CCommand_VCS_Drive();
    m_pCommand_MoveWithVelocity->InitCommand(DRIVE_MOVE_WITH_VELOCITY);

    //Init SetVelocityProfile
    m_pCommand_SetVelocityProfile = new CCommand_VCS_Drive();
    m_pCommand_SetVelocityProfile->InitCommand(DRIVE_SET_VELOCITY_PROFILE);
}

void CCommandSetProfileVelocityMode_VCS_Drive::DeleteCommands()
{
    if(m_pCommand_GetTargetVelocity)
    {
...
CXXMLFile::CElementPart* CCommandSetProfileVelocityMode_VCS_Drive::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetProfileVelocityMode_VCS_Drive::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetProfileVelocityMode_VCS_Drive::ResetJournalManager()
{
...
BOOL CCommandSetProfileVelocityMode_VCS_Drive::InitGateway(CGateway *p_pGateway)
{
