...
//////////////////////////////////////////////////////////////////////
CCommandSetConfigurationMotor_VCS_Drive::CCommandSetConfigurationMotor_VCS_Drive()
{
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_SetMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usMotorType, WORD p_usNominalCurrent, WORD p_usMaxOutputCurrent, BYTE p_ubNbOfPolePairs, WORD p_usThermalTimeConstant, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_GetMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD *p_pusMotorType, WORD *p_pusNominalCurrent, WORD *p_pusMaxOutputCurrent, BYTE *p_pubNbOfPolePairs, WORD *p_pusThermalTimeConstant, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_SetMotorType(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usMotorType, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_GetMotorType(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD *p_pusMotorType, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_SetDcMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNominalCurrent, WORD p_usMaxOutputCurrent, WORD p_usThermalTimeConstant, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_GetDcMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD *p_pusNominalCurrent, WORD *p_pusMaxOutputCurrent, WORD *p_pusThermalTimeConstant, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_SetEcMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNominalCurrent, WORD p_usMaxOutputCurrent, WORD p_usThermalTimeConstant, BYTE p_ubNbOfPolePair, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::VCS_GetEcMotorParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD *p_pusNominalCurrent, WORD *p_pusMaxOutputCurrent, WORD *p_pusThermalTimeConstant, BYTE *p_pubNbOfPolePair, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetConfigurationMotor_VCS_Drive::InitCommands()
{
    DeleteCommands();

    //Init SetMotorParameter
    m_pCommand_SetMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_SetMotorParameter->InitCommand(DRIVE_SET_MOTOR_PARAMETER);

    //Init GetMotorParameter
    m_pCommand_GetMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_GetMotorParameter->InitCommand(DRIVE_GET_MOTOR_PARAMETER);

    //Init SetMotorType
    m_pCommand_SetMotorType = new CCommand_VCS_Drive();
    m_pCommand_SetMotorType->InitCommand(DRIVE_SET_MOTOR_TYPE);

    //Init GetMotorType
    m_pCommand_GetMotorType = new CCommand_VCS_Drive();
    m_pCommand_GetMotorType->InitCommand(DRIVE_GET_MOTOR_TYPE);

    //Init SetDcMotorParameter
    m_pCommand_SetDcMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_SetDcMotorParameter->InitCommand(DRIVE_SET_DC_MOTOR_PARAMETER);

    //Init GetDcMotorParameter
    m_pCommand_GetDcMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_GetDcMotorParameter->InitCommand(DRIVE_GET_DC_MOTOR_PARAMETER);

    //Init SetEcMotorParameter
    m_pCommand_SetEcMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_SetEcMotorParameter->InitCommand(DRIVE_SET_EC_MOTOR_PARAMETER);

    //Init GetEcMotorParameter
    m_pCommand_GetEcMotorParameter = new CCommand_VCS_Drive();
    m_pCommand_GetEcMotorParameter->InitCommand(DRIVE_GET_EC_MOTOR_PARAMETER);
}

void CCommandSetConfigurationMotor_VCS_Drive::DeleteCommands()
{
    if(m_pCommand_SetMotorParameter)
    {
...
CXXMLFile::CElementPart* CCommandSetConfigurationMotor_VCS_Drive::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetConfigurationMotor_VCS_Drive::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetConfigurationMotor_VCS_Drive::ResetJournalManager()
{
...
BOOL CCommandSetConfigurationMotor_VCS_Drive::InitGateway(CGateway *p_pGateway)
{
