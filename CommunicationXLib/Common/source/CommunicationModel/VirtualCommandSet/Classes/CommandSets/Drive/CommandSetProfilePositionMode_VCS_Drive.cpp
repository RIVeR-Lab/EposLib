// CommandSetProfilePositionMode_VCS_Drive.cpp: Implementierung der Klasse CCommandSetProfilePositionMode_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetProfilePositionMode_VCS_Drive.h"
...
//////////////////////////////////////////////////////////////////////
CCommandSetProfilePositionMode_VCS_Drive::CCommandSetProfilePositionMode_VCS_Drive()
{
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::VCS_GetPositionProfile(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD* p_pulProfileVelocity, DWORD* p_pulProfileAcceleration, DWORD* p_pulProfileDeceleration, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::VCS_HaltPositionMovement(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::VCS_SetPositionProfile(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD p_ulProfileVelocity, DWORD p_ulProfileAcceleration, DWORD p_ulProfileDeceleration, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::VCS_EnablePositionWindow(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD p_ulPositionWindow, WORD p_usPositionWindowTime, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::VCS_DisablePositionWindow(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetProfilePositionMode_VCS_Drive::InitCommands()
{
    DeleteCommands();

    //Init command GetPositionProfile
    m_pCommand_GetPositionProfile = new CCommand_VCS_Drive();
    m_pCommand_GetPositionProfile->InitCommand(DRIVE_GET_POSITION_PROFILE);

    //Init command GetTargetPosition
    m_pCommand_GetTargetPosition = new CCommand_VCS_Drive();
    m_pCommand_GetTargetPosition->InitCommand(DRIVE_GET_TARGET_POSITION);

    //Init command HaltPositionMovement
    m_pCommand_HaltPositionMovement = new CCommand_VCS_Drive();
    m_pCommand_HaltPositionMovement->InitCommand(DRIVE_HALT_POSITION_MOVEMENT);

    //Init command MoveToPosition
    m_pCommand_MoveToPosition = new CCommand_VCS_Drive();
    m_pCommand_MoveToPosition->InitCommand(DRIVE_MOVE_TO_POSITION);

    //Init SetPositionProfile
    m_pCommand_SetPositionProfile = new CCommand_VCS_Drive();
    m_pCommand_SetPositionProfile->InitCommand(DRIVE_SET_POSITION_PROFILE);

    //Init EnablePositionWindow
    m_pCommand_EnablePositionWindow = new CCommand_VCS_Drive();
    m_pCommand_EnablePositionWindow->InitCommand(DRIVE_ENABLE_POSITION_WINDOW);

    //Init DisablePositionWindow
    m_pCommand_DisablePositionWindow = new CCommand_VCS_Drive();
    m_pCommand_DisablePositionWindow->InitCommand(DRIVE_DISABLE_POSITION_WINDOW);
}

void CCommandSetProfilePositionMode_VCS_Drive::DeleteCommands()
{
    if(m_pCommand_GetPositionProfile)
    {
...
CXXMLFile::CElementPart* CCommandSetProfilePositionMode_VCS_Drive::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetProfilePositionMode_VCS_Drive::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetProfilePositionMode_VCS_Drive::ResetJournalManager()
{
...
BOOL CCommandSetProfilePositionMode_VCS_Drive::InitGateway(CGateway *p_pGateway)
{
