// CommandSetProfilePositionMode_VCS_Drive.h: Schnittstelle f�r die Klasse CCommandSetProfilePositionMode_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CommandSetProfilePositionMode_VCS_Drive_H__8D4BF5C9_156A_45AE_BCB2_B9E2F6097751__INCLUDED_)
#define AFX_CommandSetProfilePositionMode_VCS_Drive_H__8D4BF5C9_156A_45AE_BCB2_B9E2F6097751__INCLUDED_
...
class CCommandSetProfilePositionMode_VCS_Drive : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetProfilePositionMode_VCS_Drive();
    virtual ~CCommandSetProfilePositionMode_VCS_Drive();
...
private:
    ...
    CCommand_VCS_Drive* m_pCommand_GetPositionProfile;
    CCommand_VCS_Drive* m_pCommand_GetTargetPosition;
    CCommand_VCS_Drive* m_pCommand_HaltPositionMovement;
    CCommand_VCS_Drive* m_pCommand_MoveToPosition;
    CCommand_VCS_Drive* m_pCommand_SetPositionProfile;
    CCommand_VCS_Drive* m_pCommand_EnablePositionWindow;
    CCommand_VCS_Drive* m_pCommand_DisablePositionWindow;
};

#endif // !defined(AFX_CommandSetProfilePositionMode_VCS_Drive_H__8D4BF5C9_156A_45AE_BCB2_B9E2F6097751__INCLUDED_)
