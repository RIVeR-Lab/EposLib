// CommandSetInputsPositionMarker_VCS_Drive.h: Schnittstelle f�r die Klasse CCommandSetInputsPositionMarker_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////
...
class CCommandSetInputsPositionMarker_VCS_Drive : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetInputsPositionMarker_VCS_Drive();
    virtual ~CCommandSetInputsPositionMarker_VCS_Drive();
...
private:
    ...
    CCommand_VCS_Drive* m_pCommand_SetPositionMarkerParameter;
    CCommand_VCS_Drive* m_pCommand_GetPositionMarkerParameter;
    CCommand_VCS_Drive* m_pCommand_ActivatePositionMarker;
    CCommand_VCS_Drive* m_pCommand_DeactivatePositionMarker;
    CCommand_VCS_Drive* m_pCommand_ReadPositionMarkerCounter;
    CCommand_VCS_Drive* m_pCommand_ReadPositionMarkerCapturedPosition;
    CCommand_VCS_Drive* m_pCommand_ResetPositionMarkerCounter;
};
