...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_SetHomingParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD p_ulHomingAcceleration, DWORD p_ulSpeedSwitch, DWORD p_ulSpeedIndex, long p_lHomeOffset, WORD p_usCurrentThreshold, long p_lHomePosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_DefinePosition(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, long p_lHomePosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
