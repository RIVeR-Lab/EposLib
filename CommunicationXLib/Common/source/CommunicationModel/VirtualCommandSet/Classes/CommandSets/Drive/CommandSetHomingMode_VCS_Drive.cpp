// CommandSetHomingMode_VCS_Drive.cpp: Implementierung der Klasse CCommandSetHomingMode_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "CommandSetHomingMode_VCS_Drive.h"
...
CCommandSetHomingMode_VCS_Drive::CCommandSetHomingMode_VCS_Drive()
{
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_FindHome(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, __int8 p_bHomingMethod, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_GetHomingParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD *p_pulHomingAcceleration, DWORD *p_pulSpeedSwitch, DWORD *p_pulSpeedIndex, int *p_plHomeOffset, WORD* p_pusCurrentThreshold, int *p_plHomePosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_SetHomingParameter(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, DWORD p_ulHomingAcceleration, DWORD p_ulSpeedSwitch, DWORD p_ulSpeedIndex, int p_lHomeOffset, WORD p_usCurrentThreshold, int p_lHomePosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_StopHoming(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetHomingMode_VCS_Drive::VCS_DefinePosition(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, int p_lHomePosition, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetHomingMode_VCS_Drive::InitCommands()
{
    DeleteCommands();

    //Init FindHome command
    m_pCommand_FindHome = new CCommand_VCS_Drive();
    m_pCommand_FindHome->InitCommand(DRIVE_FIND_HOME);

    //Init GetHomingParameter command
    m_pCommand_GetHomingParameter = new CCommand_VCS_Drive();
    m_pCommand_GetHomingParameter->InitCommand(DRIVE_GET_HOMING_PARAMETER);

    //Init SetHomingParameter command
    m_pCommand_SetHomingParameter = new CCommand_VCS_Drive();
    m_pCommand_SetHomingParameter->InitCommand(DRIVE_SET_HOMING_PARAMETER);

    //Init Stophoming
    m_pCommand_StopHoming = new CCommand_VCS_Drive();
    m_pCommand_StopHoming->InitCommand(DRIVE_STOP_HOMING);

    //Init Define Position
    m_pCommand_DefinePosition = new CCommand_VCS_Drive();
    m_pCommand_DefinePosition->InitCommand(DRIVE_DEFINE_POSITION);
}

void CCommandSetHomingMode_VCS_Drive::DeleteCommands()
{
    if(m_pCommand_FindHome)
    {
...
CXXMLFile::CElementPart* CCommandSetHomingMode_VCS_Drive::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetHomingMode_VCS_Drive::ResetJournalManager()
{
...
void CCommandSetHomingMode_VCS_Drive::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
BOOL CCommandSetHomingMode_VCS_Drive::InitGateway(CGateway *p_pGateway)
{
