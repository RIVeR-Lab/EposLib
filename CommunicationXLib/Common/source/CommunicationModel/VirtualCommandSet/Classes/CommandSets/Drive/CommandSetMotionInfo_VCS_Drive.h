// CommandSetMotionInfo_VCS_Drive.h: Schnittstelle f�r die Klasse CCommandSetMotionInfo_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_CommandSetMotionInfo_VCS_Drive_H__8CD6D347_6DDA_47E7_A6FB_44593CA1E0E4__INCLUDED_)
#define AFX_CommandSetMotionInfo_VCS_Drive_H__8CD6D347_6DDA_47E7_A6FB_44593CA1E0E4__INCLUDED_
...
class CCommandSetMotionInfo_VCS_Drive : public CCommandSetBase_VCS
{
public:
    ...
    CCommandSetMotionInfo_VCS_Drive();
    virtual ~CCommandSetMotionInfo_VCS_Drive();
...
private:
    ...
    CCommand_VCS_Drive* m_pCommand_GetCurrentIs;
    CCommand_VCS_Drive* m_pCommand_GetMovementState;
    CCommand_VCS_Drive* m_pCommand_GetPositionIs;
    CCommand_VCS_Drive* m_pCommand_GetVelocityIs;
};

#endif // !defined(AFX_CommandSetMotionInfo_VCS_Drive_H__8CD6D347_6DDA_47E7_A6FB_44593CA1E0E4__INCLUDED_)
