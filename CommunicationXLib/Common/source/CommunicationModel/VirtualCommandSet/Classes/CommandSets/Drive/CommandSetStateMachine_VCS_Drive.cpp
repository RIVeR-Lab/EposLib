// CommandSetStateMachine_VCS_Drive.cpp: Implementierung der Klasse CCommandSetStateMachine_VCS_Drive.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "CommandSetStateMachine_VCS_Drive.h"
...
//////////////////////////////////////////////////////////////////////
CCommandSetStateMachine_VCS_Drive::CCommandSetStateMachine_VCS_Drive()
{
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_ClearFault(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_GetDisableState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, BOOL* p_poIsDisabled, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_GetEnableState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, BOOL* p_poIsEnabled, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_GetFaultState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, BOOL* p_poIsInFault, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_GetOperationMode(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, __int8* p_pbMode, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_GetQuickStopState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, BOOL* p_poIsQuickStoped, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_SetDisableState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_SetEnableState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_SetOperationMode(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, __int8 p_bMode, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
BOOL CCommandSetStateMachine_VCS_Drive::VCS_SetQuickStopState(CLayerManagerBase* p_pManager, HANDLE p_hHandle, HANDLE p_hTransactionHandle, WORD p_usNodeId, CErrorInfo* p_pErrorInfo)
{
    BOOL oResult = FALSE;
...
void CCommandSetStateMachine_VCS_Drive::InitCommands()
{
    DeleteCommands();

    //Init ClearFault
    m_pCommand_ClearFault = new CCommand_VCS_Drive();
    m_pCommand_ClearFault->InitCommand(DRIVE_CLEAR_FAULT);

    //Init GetDisableState
    m_pCommand_GetDisableState = new CCommand_VCS_Drive();
    m_pCommand_GetDisableState->InitCommand(DRIVE_GET_DISABLE_STATE);

    //Init GetEnableState
    m_pCommand_GetEnableState = new CCommand_VCS_Drive();
    m_pCommand_GetEnableState->InitCommand(DRIVE_GET_ENABLE_STATE);

    //Init GetFaultState
    m_pCommand_GetFaultState = new CCommand_VCS_Drive();
    m_pCommand_GetFaultState->InitCommand(DRIVE_GET_FAULT_STATE);

    //Init GetOperationMode
    m_pCommand_GetOperationMode = new CCommand_VCS_Drive();
    m_pCommand_GetOperationMode->InitCommand(DRIVE_GET_OPERATION_MODE);

    //Init GetQuickStopState
    m_pCommand_GetQuickStopState = new CCommand_VCS_Drive();
    m_pCommand_GetQuickStopState->InitCommand(DRIVE_GET_QUICK_STOP_STATE);

    //Init SetDisableState
    m_pCommand_SetDisableState = new CCommand_VCS_Drive();
    m_pCommand_SetDisableState->InitCommand(DRIVE_SET_DISABLE_STATE);

    //Init SetEnableState
    m_pCommand_SetEnableState = new CCommand_VCS_Drive();
    m_pCommand_SetEnableState->InitCommand(DRIVE_SET_ENABLE_STATE);

    //Init SetOperationMode
    m_pCommand_SetOperationMode = new CCommand_VCS_Drive();
    m_pCommand_SetOperationMode->InitCommand(DRIVE_SET_OPERATION_MODE);

    //Init SetQuickStopState
    m_pCommand_SetQuickStopState = new CCommand_VCS_Drive();
    m_pCommand_SetQuickStopState->InitCommand(DRIVE_SET_QUICK_STOP_STATE);
}

void CCommandSetStateMachine_VCS_Drive::DeleteCommands()
{
    if(m_pCommand_ClearFault)
    {
...
CXXMLFile::CElementPart* CCommandSetStateMachine_VCS_Drive::StoreToXMLFile(CXXMLFile* p_pFile, CXXMLFile::CElementPart* p_pParentElement)
{
...
void CCommandSetStateMachine_VCS_Drive::InitJournalManager(CJournalManagerBase *p_pJournalManager)
{
...
void CCommandSetStateMachine_VCS_Drive::ResetJournalManager()
{
...
BOOL CCommandSetStateMachine_VCS_Drive::InitGateway(CGateway *p_pGateway)
{
