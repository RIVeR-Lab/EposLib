// GatewayCANopenToEpos.cpp: Implementierung der Klasse CGatewayCANopenToEpos.
//
//////////////////////////////////////////////////////////////////////

#include "stdafx.h"
#include "GatewayCANopenToEpos.h"
...
CGateway* CGatewayCANopenToEpos::Clone()
{
    CGatewayCANopenToEpos* pClonedGateway;

    pClonedGateway = new CGatewayCANopenToEpos();
    *pClonedGateway = *this;
...
void CGatewayCANopenToEpos::DeleteCommands()
{
	//WriteObject
...
CGatewayCANopenToEpos& CGatewayCANopenToEpos::operator=(CGatewayCANopenToEpos& other)
{
    if(this != &other)
    {
...
BOOL CGatewayCANopenToEpos::Process_NetworkIndication(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Not supported
	return TRUE;
}
...
BOOL CGatewayCANopenToEpos::Process_SendNMTService(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Constants CANopen
...
BOOL CGatewayCANopenToEpos::Process_SendCANFrame(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Constants CANopen
...
BOOL CGatewayCANopenToEpos::Process_ReadCANFrame(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Not supported
	return FALSE;
}

BOOL CGatewayCANopenToEpos::Process_RequestCANFrame(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Constants CANopen
	const int k_ParameterIndex_CobId = 0;
	const int k_ParameterIndex_Length = 1;
...
BOOL CGatewayCANopenToEpos::Process_SendLSSFrame(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Not supported
	return FALSE;
}

BOOL CGatewayCANopenToEpos::Process_ReadLSSFrame(CCommand_PS* pCommand, CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle)
{
	//Not supported
	return FALSE;
}

BOOL CGatewayCANopenToEpos::DCS_ReadObject(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wNodeId,WORD wIndex,BYTE uSubIndex,BYTE* pObjectBuffer,DWORD dObjectBufferLength,DWORD* pdObjectLengthRead,CErrorInfo* pErrorInfo)
{
...
BOOL CGatewayCANopenToEpos::DCS_InitiateSegmentedRead(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle, WORD wNodeId, WORD wIndex, BYTE uSubIndex, CErrorInfo* pErrorInfo)
{
    DWORD dDeviceErrorCode;
    BYTE uNodeId = (BYTE)wNodeId;
    BOOL oResult = FALSE;
...
BOOL CGatewayCANopenToEpos::DCS_InitiateSegmentedWrite(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle, WORD wNodeId, WORD wIndex, BYTE uSubIndex, DWORD dObjectLength, CErrorInfo* pErrorInfo)
{
    DWORD dDeviceErrorCode;
    BYTE uNodeId = (BYTE)wNodeId;
    BOOL oResult = FALSE;
...
BOOL CGatewayCANopenToEpos::DCS_SegmentedRead(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wNodeId,BOOL oToggle,BOOL* poLastDataSegment,void** ppSegmentBuffer,DWORD* pdSegmentBufferLength,CErrorInfo* pErrorInfo)
{
	DWORD dDeviceErrorCode;
	...
	if(m_pCommand_SegmentedRead && pDeviceCommandSetManager && ppSegmentBuffer && pdSegmentBufferLength)
	{
		...
		*pdSegmentBufferLength = m_pCommand_SegmentedRead->GetReturnParameterLength(2);
		if(controlByte.structure.bLength < *pdSegmentBufferLength) *pdSegmentBufferLength = controlByte.structure.bLength;
		...
		//Restore ControlByte
		if(poLastDataSegment) *poLastDataSegment = !controlByte.structure.bMoreSegments;
...
BOOL CGatewayCANopenToEpos::DCS_SegmentedWrite(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wNodeId,BOOL oMoreSegments,BOOL oToggle,void* pSegmentBuffer,DWORD dSegmentLength,BOOL* poRetToggle,DWORD* pdSegmentLengthWritten,CErrorInfo* pErrorInfo)
{
	DWORD dDeviceErrorCode;
	UEposControlByte controlByte;
	BOOL oResult = FALSE;
	...
	if(m_pCommand_SegmentedWrite && pDeviceCommandSetManager)
	{
		...
		//Restore ControlByte
		if(poRetToggle) *poRetToggle = controlByte.structure.bToggle;
...
BOOL CGatewayCANopenToEpos::DCS_AbortSegmentedTransfer(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle, HANDLE hTransactionHandle, WORD wNodeId, WORD wIndex, WORD wSubIndex, DWORD dAbortCode, CErrorInfo* pErrorInfo)
{
...
BOOL CGatewayCANopenToEpos::DCS_WriteObject(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wNodeId,WORD wIndex,BYTE uSubIndex,BYTE* pObjectBuffer,DWORD dObjectLength,CErrorInfo* pErrorInfo)
{
	DWORD dDeviceErrorCode;
	BOOL oResult = FALSE;
	BYTE uNodeId = (BYTE)wNodeId;
...
BOOL CGatewayCANopenToEpos::DCS_SendNMTService(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wNodeId,WORD wCommandSpecifier,CErrorInfo* pErrorInfo)
{
	BOOL oResult = FALSE;
...
BOOL CGatewayCANopenToEpos::DCS_SendCANFrame(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wCobID,WORD wLength,void* pData,CErrorInfo* pErrorInfo)
{
	BOOL oResult = FALSE;
...
BOOL CGatewayCANopenToEpos::DCS_RequestCANFrame(CDeviceCommandSetManagerBase* pDeviceCommandSetManager, HANDLE hDCS_Handle,HANDLE hTransactionHandle,WORD wCobID,WORD wLength,void* pData,CErrorInfo* pErrorInfo)
{
...
WORD CGatewayCANopenToEpos::GetNodeId(DWORD dDefaultSdoCobIdClientServer)
{
...
DWORD CGatewayCANopenToEpos::CheckDataBufferLength(BOOL oSizeIndicated,BYTE uNonValidNbOfBytes,DWORD dDataBufferLength,DWORD dMaxDataBufferLength)
{
	if(oSizeIndicated)
	{
		//Size Indicated
...
BOOL CGatewayCANopenToEpos::ResetBufferedData()
{
...
BOOL CGatewayCANopenToEpos::AddBufferedData(void* pDataBuffer,DWORD dDataBufferSize,BOOL oNoMoreSegments)
{
	DWORD size;
	BYTE* p;
...
BOOL CGatewayCANopenToEpos::IsBufferedDataAvailable(DWORD dSize,DWORD* pdSizeAvailable,BOOL* poNoMoreSegments)
{
...
BOOL CGatewayCANopenToEpos::ReverseBufferedData(DWORD dReverseSize)
{
...
BOOL CGatewayCANopenToEpos::GetBufferedData(void* pDataBuffer,DWORD dDataBufferSize,DWORD* pdDataRead,BOOL* poNoMoreSegments)
{
...
BOOL CGatewayCANopenToEpos::InitLayerParameterStack(CCommandRoot* p_pCommand)
{
...
BOOL CGatewayCANopenToEpos::GetAddressParameter(CDeviceCommandSetManagerBase* p_pManager, HANDLE p_hDCS_Handle, BYTE& p_rNodeId, CErrorInfo* p_pErrorInfo)
{
