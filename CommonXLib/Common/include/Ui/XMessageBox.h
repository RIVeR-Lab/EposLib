...
struct XMSGBOXPARAMS 
{
	...
	struct CUserDefinedButtonCaptions
	{
        CUserDefinedButtonCaptions()
        {
            _tcscpy(szAbort, _T(""));
            _tcscpy(szCancel, _T(""));
            _tcscpy(szContinue, _T(""));
            _tcscpy(szDoNotAskAgain, _T(""));
            _tcscpy(szDoNotTellAgain, _T(""));
            _tcscpy(szDoNotShowAgain, _T(""));
            _tcscpy(szHelp, _T(""));
            _tcscpy(szIgnore, _T(""));
            _tcscpy(szIgnoreAll, _T(""));
            _tcscpy(szNo, _T(""));
            _tcscpy(szNoToAll, _T(""));
            _tcscpy(szOK, _T(""));
            _tcscpy(szReport, _T(""));
            _tcscpy(szRetry, _T(""));
            _tcscpy(szSkip, _T(""));
            _tcscpy(szSkipAll, _T(""));
            _tcscpy(szTryAgain, _T(""));
            _tcscpy(szYes, _T(""));
            _tcscpy(szYesToAll, _T(""));
        }
